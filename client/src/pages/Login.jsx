...
//     try {
//       const result = await login(data).unwrap();
//       // navigate("/dashboard"); // Add this line to navigate to the dashboard upon successful login
//     } catch (error) {
//       toast.error(error?.data?.message || error.message);
//     }
//   };
...
//                 label='Submit'
//                 className='w-full h-10 bg-blue-700 text-white rounded-full'
//                 isLoading={isLoading} // Pass the isLoading state to the Button component if it handles loading state
//               />
//             </div>
//           </form>
//         </div>
